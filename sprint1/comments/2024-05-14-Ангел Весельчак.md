...
* [cardref:: [[Задача которая должна перенестись на следующий спринт и содержать сложные комментарии]]]
  [action::feat]
  [spent:: 6]
  Комментарий содержащий список из ссылок которыми стоит поделиться:
  * https://obsidian.md/
  * [[https://en.wikipedia.org/wiki/Obsidian_(software)|Wiki cсылка на страницу в википеди]]
  * [Маркдаун формат ссылки](https://obsidian.md/)
